...
| External LLM tạo bài + TTS học sinh live | **Demonstrated (owner-observed)** | Credential/quota thật trên Render | Draft: `DeepSeek-V4-Flash`, 1938 tokens, 7s, trace `b69e656a`; AI Voice đã phát trên account học sinh; xem `live-demo-evidence.md` |
