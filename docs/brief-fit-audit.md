...
| AI hỗ trợ tạo full lesson/remediation | **Demonstrated** với local deterministic provider; external path **Tested** | VERIFIED source, structured slide/quiz/animation, provider/version/latency/cost trace | Live external LLM/TTS credential artifact chưa có |
...
| Live URL/video | **Planned** | Render config/runbook có sẵn; local smoke/E2E pass | Cần deploy, incognito verification và video |
| Public repository | **Planned external verification** | Git repository local tồn tại | Chủ repo phải public và kiểm tra link từ máy không đăng nhập |
...
- “Tested 70 Node tests, 23 Python tests và một live HTTP E2E.”
...
- “Đã đạt 90 điểm” — điểm là quyết định của giám khảo; tự đánh giá evidence-readiness hiện khoảng 88/100.

## Việc còn lại theo ưu tiên

1. Public deploy + health/E2E/smoke + video không cắt golden path.
